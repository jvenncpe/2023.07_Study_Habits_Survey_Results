...
In my case, the specifics about the hypothesis testing can be located in the Week 4 Excel file. *However, this marked the initial stages of the course, and the hypotheses formulated were at a foundational level as well as the visualizations.*
